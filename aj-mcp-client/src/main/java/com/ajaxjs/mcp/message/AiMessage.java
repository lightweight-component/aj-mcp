...
public class AiMessage implements ChatMessage {
    ...
    public AiMessage(String text) {
        this.text = McpUtils.ensureNotNull(text, "text");
    ...
    public AiMessage(List<ToolExecutionRequest> toolExecutionRequests) {
        this.text = null;
        this.toolExecutionRequests = McpUtils.ensureNotEmpty(toolExecutionRequests, "toolExecutionRequests");
    }
    ...
    public AiMessage(String text, List<ToolExecutionRequest> toolExecutionRequests) {
        this.text = text;
        this.toolExecutionRequests = McpUtils.copyIfNotNull(toolExecutionRequests);
    }
