...
//import static dev.langchain4j.internal.ValidationUtils.McpUtils.ensureNotNull;
//
///**
...
//        this(Image.builder()
//                .url(McpUtils.ensureNotNull(url, "url"))
//                .build(), detailLevel);
//    }
//
//    /**
...
//        this.image = McpUtils.ensureNotNull(image, "image");
//        this.detailLevel = McpUtils.ensureNotNull(detailLevel, "detailLevel");
//    }
//
//    /**
//     * Get the {@code Image}.
