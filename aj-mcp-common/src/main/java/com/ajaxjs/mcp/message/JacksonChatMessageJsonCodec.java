...
//            .addMixIn(TextFile.class, TextFileMixin.class)
    ...
    public List<ChatMessage> messagesFromJson(String json) {
        ...
        List<ChatMessage> messages = JsonUtils.fromJson(json, OBJECT_MAPPER.constructType(MESSAGE_LIST_TYPE));
    ...
    public String messageToJson(ChatMessage message) {
        try {
            return JsonUtils.OBJECT_MAPPER.writeValueAsString(message);
    ...
    public String messagesToJson(List<ChatMessage> messages) {
        try {
            return JsonUtils.OBJECT_MAPPER.writeValueAsString(messages);
        } catch (JsonProcessingException e) {
            throw new RuntimeException(e);
        }
    }
